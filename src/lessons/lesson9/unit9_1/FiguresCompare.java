...
public class FiguresCompare extends NestedFigures {
    ...
    public static void main(String[] args) {
        ...
        for (Figure figure: figures) System.out.println(figure);
        System.out.println();
...
//        class FiguresComporatorArea extends CompareGr{
//            @Override
//            boolean greater(Figure figure1, Figure figure2){
//                return figure1.area() > figure2.area();
//            }
//        }
//        FiguresComporatorArea fca = new FiguresComporatorArea();

        FiguresCompare fcArea = new FiguresCompare(
                figures,
                new CompareGr(){
                    @Override
                    boolean greater(Figure figure1, Figure figure2){
